        ...
        <div className="intro">
          ...
          >
            ...
            <div className={`nav-right ${navCollapse ? "mobile" : ""}`}>
              <div
                className="w-nav-button pointer"
                onClick={() => setNavCollapse(!navCollapse)}
              >
                <div className="icon w-icon-nav-menu"></div>
              </div>
              <div className="nav-collapse">
                <Link to="/jobs" className="nav-link w-nav-link">
                  Jobs
                </Link>
                <Link to="/#career" className="nav-link w-nav-link">
                  Career Paths
                </Link>
                <Link to="/#events" className="nav-link w-nav-link">
                  Resources
                </Link>
                <Link to="/#coaching" className="nav-link w-nav-link">
                  Coaching
                </Link>
                <Link
                  to="https://submit.miamitech.works/jobs"
                  className="nav-link button-5 w-button"
                >
                  Post a Job
                </Link>
              </div>
          ...
          <div className="columns w-row">
            <div className="column-3 w-col w-col-8">
              ...
              <div>
                <div className="d-flex">
                  ...
                  <button
                    type="button"
                    className="button-4 w-button ml-2"
                    onClick={() => actions.search(query)}
                  >
                    Search
                  </button>
                </div>
                <div className="text-block-4 text-right mt-1">
                  search results:{" "}
                  {store && Array.isArray(store.jobs.data)
                    ? store.jobs.data.length
                    : 0}{" "}
                </div>
              </div>
              {(!store ||
                !Array.isArray(store.jobs.data) ||
                (Array.isArray(store.jobs.data) &&
                    ...
                    <div className="job-card" key={index}>
                      <div className="job-description">
                        ...
                        <div className="job-tags">
                          <div
                            className="pill w-clearfix"
                            style={{
                              background: `#${job.skill_pathway_background_color}`,
                            }}
                          >
                            <div
                              className="div-block-3"
                              style={{
                                background: `#${job.skill_pathway_circle_color}`,
                              }}
                            ></div>
                            <div className="text-block cut-text">
                              {job.skill_pathway}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="logo-application">
                        <div className="date-posted">
                          <div className="date-posted this-week">
                            {jobDate &&
                              jobDate.from !== undefined &&
                              jobDate.from(now)}
                          </div>
                        </div>
                        <a
            ...
            <div className="w-col w-col-4">
              ...
              <div className="events">
                ...
                {store &&
                  Array.isArray(store.programs.data) &&
                  store.programs.data.map((p,index) => (
                    <div className="side-panel-card" key={index}>
                      <div className="course-details">
                        <FireImage
                          name={p.provider_logo_file_path}
                          alt={"Banner for " + p.provider_name}
                      ...
                      <div>
                        <div className="body-5">
                          <strong>{p.program_skill_pathway}</strong>
                          <br />
                        </div>
                        <div className="body-6">By {p.provider_name}</div>
                      </div>
                      <a
                        href={p.program_external_url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="button-4 w-button register-btn"
                      >
                        Register
                      </a>
                    </div>
          ...
          <div className="w-container">
            ...
            <div className="w-layout-grid grid-2">
              <div className="job-item">
                ...
                <div className="meta">
                  <div className="location-details">
                    <img src="images/map-pin-2.svg" alt="" />
                ...
                <div className="div-block"></div>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-17_1Rectangle-17.png" alt="" />
              ...
              <div className="job-item">
                ...
                <h3 className="heading-3">
                  Python Backend Engineer (Internship)
                </h3>
                <div className="meta">
                  <div className="location-details">
                    <img src="images/map-pin-2.svg" alt="" />
                ...
                <div className="div-block"></div>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-26_1Rectangle-26.png" alt="" />
              ...
              <div className="job-item">
                ...
                <div className="div-block"></div>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-32_1Rectangle-32.png" alt="" />
                  <div className="company">Gavac</div>
                  <div className="time">1 hour ago</div>
                </div>
              </div>
              <div id="w-node-b6a7ee7ab582-7baa406e" className="featured-job">
                <img
                  src="images/featured.png"
                  srcSet="images/featured-p-500.png 500w, images/featured.png 700w"
                  sizes="100vw"
                  alt=""
                />
                <div className="div-block-5"></div>
                <h3 className="heading-3">
                  Id dolore fugiat consectetur do sint qui irure sint esse
                </h3>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-17_1Rectangle-17.png" alt="" />
                  <div className="company">Stimuluz</div>
              ...
              <div className="job-item">
                ...
                <div className="div-block"></div>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-20_1Rectangle-20.png" alt="" />
              ...
              <div className="job-item">
                ...
                <div className="div-block"></div>
                <div className="company-excepts-and-date">
                  <img src="images/Rectangle-29_1Rectangle-29.png" alt="" />
              ...
              <div className="div-block-6">
                ...
                <p className="paragraph-2">
                  Jobs on Miami.Works.{" "}
                  <a href="#">
                    <strong className="bold-text">Explore all jobs</strong>
                  </a>
                </p>
              </div>
            </div>
        ...
        <div className="jobs">
          <div className="w-container">
            <div className="div-block-7">
              <h2 className="heading-2">
                Some companies we have helped build a better future
              </h2>
            ...
            <div className="company-cards w-row">
              <div className="w-col w-col-4">
                <img
                  src="images/com-ff.jpg"
                  srcSet="images/com-ff-p-500.jpeg 500w, images/com-ff-p-800.jpeg 800w, images/com-ff-p-1080.jpeg 1080w, images/com-ff.jpg 1566w"
                  sizes="100vw"
                  alt=""
                  className="image-3"
                />
              ...
              <div className="column-2 w-col w-col-8">
                <div className="w-layout-grid grid-3">
                  <div className="com-card">
                    <img
                      src="images/figma-wordmark-1.png"
                      alt=""
                      className="image-4"
                    />
                    <p className="text-center-white">
                      Est consequat in proident occaecat et nulla sint cillum
                      aliqua laborum commodo.
                    </p>
                  </div>
                  <div className="com-card airb">
                    <img src="images/image-1.png" alt="" className="image-4" />
                    <p className="text-center-white">
                      Est consequat in proident occaecat et nulla sint cillum
                      aliqua laborum commodo.
                    </p>
                  </div>
                  <div className="com-card green">
                    <img src="images/image-2.png" alt="" className="image-4" />
                    <p className="text-center-white">
                      Est consequat in proident occaecat et nulla sint cillum
                      aliqua laborum commodo.
                    </p>
          ...
          <div className="w-container">
            <div className="div-block-7">
              ...
              <p className="paragraph-2">
                New jobs daily.{" "}
                <a href="#">
                  <strong className="bold-text">Explore all companies</strong>
                </a>
              </p>
            </div>
            <div className="div-block"></div>
            <div className="w-layout-grid grid-4">
              <div className="job-item">
                <img
                  src="images/Rectangle-47.jpg"
                  alt=""
                  className="company-image"
                />
                <h3 className="heading-3">Stimuluz.io</h3>
                <p className="p">
                  Elit dolore proident aute eu labore. Elit dolore proident aute
                  eu labore.
                </p>
                <div className="div-block"></div>
                <div className="meta">
        ...
        <div className="footer">
          <div className="w-container">
            <div className="div-block-8">
              <h1 className="heading foote">
                Miami <strong className="bold-text-2">Works</strong>
              </h1>
            ...
            <div className="credits">
              <img src="images/footer-logo.svg" alt="" className="image-6" />
              <div>
                <a href="#" className="footer-cred">
                  About
                </a>
                <a href="#" className="footer-cred">
                  Privacy &amp; Legal
